...
class EnvWorker(Worker):
    ...
    def init_worker(self):
        ...
        if self.cfg.env.train.simulator_type == "roborl":
            from rlinf.envs.roborl.roborl_env_lerobot import RoborlEnv
    ...
    def env_interact_step(
        ...
        """
        chunk_actions = prepare_actions(       # * doing nothing.
    ...
    def recv_chunk_actions(self):
        ...
        if self.cfg.rollout.unnorm_key != "roborl":
